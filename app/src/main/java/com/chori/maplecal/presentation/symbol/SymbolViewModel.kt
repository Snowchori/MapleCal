...
import com.chori.maplecal.domain.GetSymbolUseCase
import com.chori.maplecal.domain.SetSymbolUseCase
...
class SymbolViewModel @Inject constructor(
    ...
    fun getSymbolCheked(name: String): Boolean {
        val index = when (name) {
            "longways" -> 0
            "chuchu" -> 1
            "lehlne" -> 2
        ...
        return if (index == -1)
            ...
            getSymbolUseCase.getSymbolChecked(index)
    }
