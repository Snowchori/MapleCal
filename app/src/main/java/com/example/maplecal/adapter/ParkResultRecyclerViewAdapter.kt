...
class ParkResultRecyclerViewAdapter : RecyclerView.Adapter<ParkResultRecyclerViewAdapter.MyViewHolder>() {
    var datalist = mutableListOf<ParkData>()

    class MyViewHolder(val binding: ItemRecyclerParkResultBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val binding = ItemRecyclerParkResultBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.requestPoint.text = getPoint(datalist[position].parkCount.toInt(), datalist[position].parkPoint.toInt())
        holder.binding.parkGain.text = getTime(datalist[position].parkIndex,
